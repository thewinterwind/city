...
Route::middleware(['auth','admin'])->group(function(){Route::get('/admin',[AdminController::class,'index']);Route::post('/admin/review/{id}',[AdminController::class,'review']);Route::post('/admin/listings/{id}/visibility',[AdminController::class,'archive']);Route::post('/admin/listings/{id}/rank',[AdminController::class,'rank']);});
